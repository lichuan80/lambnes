...
public class NesCpuRORTest
{
	...
	public void testAccumulator()
	{
		...
		assertEquals(0x65,this.getCpu().getAccumulator());
		...
		this.getTestUtils().performInstruction(instruction, 0x01);
		logger.debug("accumulator: " + this.getCpu().getAccumulator());		
		logger.debug("bits: " + Integer.toBinaryString(this.getCpu().getAccumulator()));
		assertEquals(0x80,this.getCpu().getAccumulator());
		assertFalse(this.getCpu().getFlags().isCarry());
		assertFalse(this.getCpu().getFlags().isNegative());
		assertFalse(this.getCpu().getFlags().isZero());
	...
	public void testZeroPage()
	{
		...
		// test case 1
		this.getTestUtils().setMemory(0x01,0xFF);
		this.getTestUtils().performInstruction(instruction);
		logger.debug("accumulator: " + Integer.toHexString(this.getCpu().getAccumulator()));		
		assertEquals(0x7f,this.getCpuMemory().getMemoryFromHexAddress(0x01));
		assertTrue(this.getCpu().getFlags().isCarry());
		assertFalse(this.getCpu().getFlags().isNegative());
		assertFalse(this.getCpu().getFlags().isZero());
		
		// test case 2 
		this.getTestUtils().setMemory(0x03,0x15);
		this.getTestUtils().performInstruction(instruction);
		logger.debug("accumulator: " + this.getCpu().getAccumulator());		
		logger.debug("bits: " + Integer.toBinaryString(this.getCpu().getAccumulator()));
		assertEquals(0xA,this.getCpuMemory().getMemoryFromHexAddress(0x03));
		assertTrue(this.getCpu().getFlags().isCarry());
		assertFalse(this.getCpu().getFlags().isNegative());
		assertFalse(this.getCpu().getFlags().isZero());	
		
		// test case 3
		this.getTestUtils().setMemory(0x05, 0xCA);
		this.getTestUtils().performInstruction(instruction);
		logger.debug("accumulator: " + this.getCpu().getAccumulator());		
		logger.debug("bits: " + Integer.toBinaryString(this.getCpu().getAccumulator()));
		assertTrue(this.getCpuMemory().getMemoryFromHexAddress(0x05) != 194);
		assertEquals(0x65,this.getCpuMemory().getMemoryFromHexAddress(0x05));
		assertFalse(this.getCpu().getFlags().isCarry());
		assertFalse(this.getCpu().getFlags().isNegative());
		assertFalse(this.getCpu().getFlags().isZero());
	}	
	...
	public void testZeroPageXIndexed()
	{
		...
		this.getTestUtils().performInstruction(instruction);
		logger.debug("accumulator: " + Integer.toHexString(this.getCpu().getAccumulator()));		
		assertEquals(0x7f,this.getCpuMemory().getMemoryFromHexAddress(0x03));
		assertTrue(this.getCpu().getFlags().isCarry());
		assertFalse(this.getCpu().getFlags().isNegative());
		assertFalse(this.getCpu().getFlags().isZero());
		...
		logger.debug("accumulator: " + this.getCpu().getAccumulator());		
		logger.debug("bits: " + Integer.toBinaryString(this.getCpu().getAccumulator()));
		assertEquals(0xA,this.getCpuMemory().getMemoryFromHexAddress(0x06));
		assertTrue(this.getCpu().getFlags().isCarry());
		assertFalse(this.getCpu().getFlags().isNegative());
		assertFalse(this.getCpu().getFlags().isZero());	
		...
		logger.debug("bits: " + Integer.toBinaryString(this.getCpu().getAccumulator()));
		assertTrue(this.getCpu().getAccumulator() != 194);
		assertEquals(0x65,this.getCpuMemory().getMemoryFromHexAddress(0x09));
		assertFalse(this.getCpu().getFlags().isCarry());
		assertFalse(this.getCpu().getFlags().isNegative());
		assertFalse(this.getCpu().getFlags().isZero());
	}	
	...
	public void testAbsoluteX()
	{
		...
		this.getTestUtils().performInstruction(instruction);
		logger.debug("accumulator: " + Integer.toHexString(this.getCpu().getAccumulator()));		
		assertEquals(0x7f,this.getCpuMemory().getMemoryFromHexAddress(0x04));
		assertTrue(this.getCpu().getFlags().isCarry());
		assertFalse(this.getCpu().getFlags().isNegative());
		assertFalse(this.getCpu().getFlags().isZero());
		...
		logger.debug("accumulator: " + this.getCpu().getAccumulator());		
		logger.debug("bits: " + Integer.toBinaryString(this.getCpu().getAccumulator()));
		assertEquals(0xA,this.getCpuMemory().getMemoryFromHexAddress(0x09));
		assertTrue(this.getCpu().getFlags().isCarry());
		assertFalse(this.getCpu().getFlags().isNegative());
		assertFalse(this.getCpu().getFlags().isZero());	
		...
		logger.debug("bits: " + Integer.toBinaryString(this.getCpu().getAccumulator()));
		assertTrue(this.getCpu().getAccumulator() != 194);
		assertEquals(0x65,this.getCpuMemory().getMemoryFromHexAddress(0x0D));
		assertFalse(this.getCpu().getFlags().isCarry());
		assertFalse(this.getCpu().getFlags().isNegative());
		assertFalse(this.getCpu().getFlags().isZero());
	}
